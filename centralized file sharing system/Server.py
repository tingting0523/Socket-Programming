...
class server:
    ...
    # Tingting
    # Function to receive an uploaded file from client
        ...
        with open(save_path, 'wb') as f:
            ...
            while True:
                ...
                if not data:
                    break 
                f.write(data)
        print(f"File {fileName} uploaded successfully to share folder!")
    ...
    def start(self):
        ...
        while True:
            ...
            if(header==protocol.HEAD_REQUEST):
                ...
                self.receiveFile(connectionSocket, msg) #Tingting
            else:
